...
const OnlineUsersList = ({
  ...
  return (
    <section className="w-[29%] py-3 border-r px-2 lg:px-4 border-gray-800">
      <div className="text-white flex items-center gap-2 p-1 px-2 bg-gray-800 rounded-xl mb-2">
        <svg
